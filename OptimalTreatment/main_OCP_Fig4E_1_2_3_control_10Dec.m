...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function main_OCP_Fig4E_1_2_3_control_10Dec()
...
[Ju1,P1,P2]=cost_u1(TxCD,MCF7_with_CAF2_low_dose_control_TypeI,u1,u1);
fprintf('Type I \n');
...
[Ju2,P1,P2]=cost_u2(TxCD,MCF7_with_CAF2_low_dose_control_TypeII,u2,u2);
fprintf('Type II \n');
fprintf('Tumor size = %.3f, Control = %.3f, J = %.3f \n', P1,P2,Ju2);
...
[Ju3,P1,P2]=cost_u3(TxCD,MCF7_with_CAF2_low_dose_control_TypeIII,u3,u3);
fprintf('Type III \n');
fprintf('Tumor size = %.3f, Control = %.3f, J = %.3f \n', P1,P2,Ju3);
...
[Ju1u3,P1,P2]=cost_u1_u3(TxCD,MCF7_with_CAF2_low_dose_control_TypeI_III,u1,u3);
fprintf('Type I+III \n');
fprintf('Tumor size = %.3f, Control = %.3f, J = %.3f \n', P1,P2,Ju1u3);
...
[Ju2u3,P1,P2]=cost_u2_u3(TxCD,MCF7_with_CAF2_low_dose_control_TypeII_III,u2,u3);
fprintf('Type II+III \n');
fprintf('Tumor size = %.3f, Control = %.3f, J = %.3f \n', P1,P2,Ju2u3);
