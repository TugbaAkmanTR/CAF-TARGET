...
for i=1:1 % 5 mice
    ...
    index_treatment(i) = min(find(Tu == t_data_high_dose(first_nonzero_idx) ))
    ...
    %hold on
    %plot(Tu_treatment(:,i),u2_high_dose_control(:,i),'r--','LineWidth',4)
    hold on
    ...
    %hold on
    %plot(Tu_treatment(:,i),u3_high_dose_control_TypeI_III(:,i),'k-','LineWidth',4)
    grid on
    ...
    sgtitle('High dose E2 (0.5mg) (with CAF)','fontsize',18)
    ...
    %sgtitle('High dose E2 (0.5mg) (with CAF2)','fontsize',18)
